 ...
 *   5      1    2
 *
 *   前序遍历，路径之和是 395 + 391 + 302 + 39 + 30 + 3
 */
public class AllPathNumSum {
    ...
    public int helper(TreeNode node, int path){
        ...
        // 如果没到叶子节点，则继续处理孩子节点
        return  path + helper(node.left, path) + helper(node.right, path);
    }

    public static void main(String[] args) {
        AllPathNumSum leafPathNumSum = new AllPathNumSum();
