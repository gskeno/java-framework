...
public class NIOSelectorNonblockingWriteServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        serverSocketChannel.bind(new InetSocketAddress("127.0.0.1", 8000), 50);
    ...
    private static void handleRead(SelectionKey selectionKey) throws IOException {
        ...
        System.out.println("receive message from client. client:{} message length:{} " +  socketChannel.getRemoteAddress() + "," + readBuffer.position());
    ...
    private static void handleWrite(SelectionKey selectionKey) throws IOException {
        ...
        System.out.println("send message to client. client:{} message length:{} " +  socketChannel.getRemoteAddress() + "," +  writeLength);
