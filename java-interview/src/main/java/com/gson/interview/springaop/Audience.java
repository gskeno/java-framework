package com.gson.interview.springaop;
...
//    }
    ...
    @Around("execution(** com.gson.interview.springaop.Performance.perform(String)) && args(styles)")
    ...
    //注意，切点表达式中的参数名称要与切点方法中的参数名称一致，这里都是styles
    @Around("execution(** com.gson.interview.springaop.Performance.feel(Light)) && args(light)")
