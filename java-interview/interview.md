...
- [通过分析LinkedHashMap了解LRU](https://juejin.cn/post/6844903669121417224)
...
### NIO
- [Buffer（ByteBuffer）以及flip,clear及rewind区别](https://blog.csdn.net/qq_24236769/article/details/77127069)
- [NIO：关于ByteBuffer的几个关键属性](https://my.oschina.net/blacklands/blog/1186818)
...
- [Paxos英文原稿与中文译本](https://github.com/dappFinance/paxos_raft_protocol)
- [知乎Paxos算法详解](https://zhuanlan.zhihu.com/p/31780743)
- [youtube Paxos 分布式共识算法的介绍和 Go 实现，论文笔记](https://www.youtube.com/watch?v=bkWL4mtiVbs)
...
- [Elasticsearch 面试](https://dunwu.github.io/db-tutorial/nosql/elasticsearch/elasticsearch-interview.html#%E9%9B%86%E7%BE%A4%E9%83%A8%E7%BD%B2)
...
- [https://blog.csdn.net/weixin_44780082/article/details/112239269](https://blog.csdn.net/weixin_44780082/article/details/112239269)
...
### 算法
- [剑指Offer面试题：11.打印1到最大的n位数](https://www.cnblogs.com/edisonchou/p/4762114.html)
...
- [前序遍历的应用-序列化和反序列化二叉树](https://github.com/gsonkeno/java-framework/blob/master/java-algo/src/main/java/com/gson/algo/tree/SerializeAndDeserialize.java)
- [前序遍历的应用-根节点到叶子节点路径之和](https://github.com/gsonkeno/java-framework/blob/master/java-algo/src/main/java/com/gson/algo/tree/LeafPathNumSum.java)
- [前序遍历的应用-向下路径节点值之和-回溯](https://github.com/gsonkeno/java-framework/blob/master/java-algo/src/main/java/com/gson/algo/tree/PathSumEqualFixedDigit.java)
- [后序遍历的应用-节点值之和最大的路径](https://github.com/gsonkeno/java-framework/blob/master/java-algo/src/main/java/com/gson/algo/tree/MaxPathSum.java)
